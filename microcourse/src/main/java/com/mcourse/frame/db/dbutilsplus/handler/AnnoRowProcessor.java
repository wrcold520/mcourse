...
/**
 * Edited by Assassin referenced BasicRowProcessor
 * 
 ...
 *
 * @Created Assassin
 * @DateTime 2017/06/17 14:44:01
 */
public class AnnoRowProcessor implements RowProcessor {

	/** slf log **/
	public static final Logger logger = LoggerFactory.getLogger(AnnoRowProcessor.class);

	/**
	 * The default BeanProcessor instance to use if not supplied in the
	 * constructor.
	 */
	private static final AnnoBeanProcessor defaultConvert = new AnnoBeanProcessor();

	/**
	 * The Singleton instance of this class.
	 */
	private static final AnnoBeanProcessor instance = new AnnoBeanProcessor();

	/** added by wangzf default DBAnnoParse DbutilsPlusAnnoParse **/
	private static final BaseDBAnnoParse defaultDbAnnoParse = DbutilsPlusAnnoParse.getInstance();
	 ...
	 */
	@Deprecated
	public static AnnoBeanProcessor instance() {
		return instance;
	}
	 ...
	 */
	private final AnnoBeanProcessor convert;

	private final BaseDBAnnoParse dbAnnoParse;

	/**
	 * BasicRowProcessor constructor. Bean processing defaults to a
	 * BeanProcessor instance.
	 */
	public AnnoRowProcessor() {
		this(defaultDbAnnoParse);
	}

	/**
	 * Added by wangzf @20170719
	 * 
	 * @param dbAnnoParse
	 */
	public AnnoRowProcessor(BaseDBAnnoParse dbAnnoParse) {
		this(defaultConvert, dbAnnoParse);
	}

	/**
	 * BasicRowProcessor constructor.
	 * 
	 * @param defaultconvert
	 *            The BeanProcessor to use when converting columns to bean
	 *            properties.
	 * @since DbUtils 1.1
	 */
	public AnnoRowProcessor(AnnoBeanProcessor defaultconvert, BaseDBAnnoParse dbAnnoParse) {
		super();
	...
	public <T> T toBean(ResultSet rs, Class<T> type) throws SQLException {
		return this.convert.toBean(rs, type, this.dbAnnoParse);
	}
	...
	public <T> List<T> toBeanList(ResultSet rs, Class<T> type) throws SQLException {
		return this.convert.toBeanList(rs, type, dbAnnoParse);
	}
